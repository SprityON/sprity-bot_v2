...
module.exports = {
  ...
  async execute(msg, args) {
    ...
    if (overTime) {
      ...
      DB.query(`update members set points = '${points += 3000}' where member_id = '${msg.member.id}'`)
      return msg.replyEmbed(`You have received your **${Utils.normalizePrice(3000)}** monthly points!`)
