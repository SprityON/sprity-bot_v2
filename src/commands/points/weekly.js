...
module.exports = {
  ...
  async execute(msg, args) {
    ...
    if (overTime) {
      ...
      return msg.reply({ embeds: [sendEmbed(`You have received your ${point} **${Utils.normalizePrice(1000)}** weekly points!`)] })
    } else msg.reply({ embeds: [sendEmbed(`You cannot claim your weekly yet.\nPlease wait: **${overTimeMessage}**`)] })
  },
